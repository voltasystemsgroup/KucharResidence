...
namespace CrestronModule_ONKYO_TX_RZ810_IP_V1_0_PROCESSOR
{
    public class CrestronModuleClass_ONKYO_TX_RZ810_IP_V1_0_PROCESSOR : SplusObject
    {
    ...
    object VOLUME_UP_OnPush_1 ( Object __EventInfo__ )
        ...
        try
        {
            ...
            if ( Functions.TestForTrue  ( ( Functions.BoolToInt ( IVOL < 200 ))  ) ) 
                { 
                ...
                MakeString ( VOLUME_TEXT , "{0}{1}{2}", Functions.ItoA (  (int) ( (IVOL / 2) ) ) , "." , Functions.ItoA (  (int) ( (Mod( IVOL , 2 ) * 5) ) ) ) ; 
                } 
...
object VOLUME_IN_OnChange_4 ( Object __EventInfo__ )
    ...
    try
    {
        ...
        if ( Functions.TestForTrue  ( ( Functions.BoolToInt ( (Functions.TestForTrue ( Functions.BoolToInt ( (Functions.TestForTrue ( Functions.BoolToInt ( (Functions.TestForTrue ( Functions.BoolToInt ( VOLUME_IN  .UshortValue <= 200 ) ) && Functions.TestForTrue ( Functions.BoolToInt ( VOLUME_IN  .UshortValue >= 0 ) )) ) ) && Functions.TestForTrue ( Functions.BoolToInt (IVOLCHANGING == 0) )) ) ) && Functions.TestForTrue ( Functions.BoolToInt (VOLUME_IN  .UshortValue != IVOL) )) ))  ) ) 
            { 
...
public CrestronModuleClass_ONKYO_TX_RZ810_IP_V1_0_PROCESSOR ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
...
const uint VOLUME_TEXT__AnalogSerialOutput__ = 3;
